# Reference from Hugging Face: https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/trainer_seq2seq.py 
...
class SummarizationTrainer(Trainer):
    def __init__(self, *args, eval_examples=None, gen_strategy=None, post_process_function=None, **kwargs):
